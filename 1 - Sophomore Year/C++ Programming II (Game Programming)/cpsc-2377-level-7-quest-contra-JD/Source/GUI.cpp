...
Object::Command GUI::getCommand() {
	...
	*command = Object::Command::NA;
	...
	if (event->type == SDL_KEYDOWN) {
		...
		case SDLK_SPACE: *command = Object::Command::shoot; break;
...
void GUI::loadMedia(){
	...
	objectTextures[Object::Type::bullet]->load(renderer, "./Assets/Images/bullet.png");

	objectTextures[Object::Type::heart] = new Texture();
	objectTextures[Object::Type::heart]->load(renderer, "./Assets/Images/heart.png");

	objectTextures[Object::Type::tank] = new Texture();
	objectTextures[Object::Type::tank]->load(renderer, "./Assets/Images/tank.png");

	objectTextures[Object::Type::cannonball] = new Texture();
	objectTextures[Object::Type::cannonball]->load(renderer, "./Assets/Images/cannonball.png");

	objectTextures[Object::Type::dragon] = new Texture();
	objectTextures[Object::Type::dragon]->load(renderer, "./Assets/Images/dragon.png");

	objectTextures[Object::Type::fireball] = new Texture();
	objectTextures[Object::Type::fireball]->load(renderer, "./Assets/Images/fireball.png");
...
void GUI::displayGameState(const Engine* engine){
	...
	for (const auto object: objects)
	{
		...
		case Object::Type::enemy:
			objectTextures[Object::Type::enemy]->render(renderer, object->getPosition(), enemyClips[((Enemy*)object)->getCurrentSprite()]);
			break;
		case Object::Type::player:
			objectTextures[Object::Type::player]->render(renderer, object->getPosition(), playerClips[((Player*)object)->getCurrentSprite()]);
			break;
		default:
	...
	else
	{
		...
		case Object::Command::shoot: text = "Shoot"; break;
		}
	}
...
Vector2D GUI::getDimensions(const Object * object) const
{
	...
	case Object::Type::player:
		...
		{
			return { (float)playerClips[((Player*)object)->getCurrentSprite()]->w, (float)playerClips[((Player*)object)->getCurrentSprite()]->h };
		}
		break;
	case Object::Type::enemy:
	{
		if (((Enemy*)object)->getCurrentSprite() < (int)enemyClips.size())
		{
			return { (float)enemyClips[((Enemy*)object)->getCurrentSprite()]->w, (float)enemyClips[((Enemy*)object)->getCurrentSprite()]->h };
		}
		break;
	}
	...
	case Object::Type::tank:
		return { 96, 56 };
		break;
	case Object::Type::fireball:
		return { 15,10 };
		break;
	case Object::Type::cannonball:
		return { 25, 25 };
		break;
