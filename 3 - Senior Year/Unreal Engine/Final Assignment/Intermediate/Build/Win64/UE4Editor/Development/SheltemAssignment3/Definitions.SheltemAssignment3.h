...
#define UE_PROJECT_NAME SheltemAssignment5
#define UE_TARGET_NAME SheltemAssignment3Editor
#define UE_MODULE_NAME "SheltemAssignment3"
...
#define SHELTEMASSIGNMENT3_API DLLEXPORT
