...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String country_description = getString(R.string.country_title_description);
        TextView country_description_text = (TextView) findViewById(R.id.country_description_text);
        country_description_text.setText(country_description);
    }
